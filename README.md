# Cryptosat tutorial ![Cryptosat logo](https://www.cryptosat.io/images/Logo.svg)
...
### Running the tutorial server locally
...
to serve the tutorial on [http://localhost:3000](http://localhost:3000).
